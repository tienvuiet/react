...
class SavingAccount extends Account {
    constructor(accountNumber: number, banlance: number, history: string[], status: string,public interestRate: number, public overdraftLimit: number) {
...
used.withdraw(1221)
used.showHistory()
const used2 = new SavingAccount(1232132, 12000, [], "active",0.12, 133213213)
